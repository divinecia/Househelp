...
export const getCriminalRecordOptions = () =>
  fetchOptions("criminal_record_options");
export const getSmokingDrinkingOptions = () =>
  fetchOptions("smoking_drinking_restrictions");
