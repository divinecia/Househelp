...
import { Plus, Clock, DollarSign, Users, Star, MapPin, Calendar, Briefcase } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/homeowner/booking" className="text-blue-600 hover:text-blue-500 text-sm">
              View All
            </Link>
          </div>
          ...
          {upcomingBookings.length === 0 ? (
            <div className="text-center py-8 text-gray-500">
              ...
              <Link to="/homeowner/booking" className="text-blue-600 hover:text-blue-500 mt-2 inline-block">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/homeowner/jobs" className="text-blue-600 hover:text-blue-500 text-sm">
              View All
            </Link>
          </div>
            ...
            <div className="space-y-4">
              {recentJobs.map((job) => (
                <div key={job.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    <p className="font-medium text-gray-900">RWF {job.amount.toLocaleString()}</p>
