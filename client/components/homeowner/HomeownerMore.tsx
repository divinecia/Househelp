...
export default function HomeownerMore() {
  ...
  const [activeTab, setActiveTab] = useState<'notifications' | 'settings' | 'help' | 'billing'>('notifications');
      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'Your booking with Alice Mukamana for Dec 7th has been confirmed',
          type: 'success',
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  <div>
                    <p className="font-medium text-gray-900">House Cleaning - Alice Mukamana</p>
                ...
                <div className="flex justify-between items-center p-3 bg-gray-50 rounded">
                  <div>
                    <p className="font-medium text-gray-900">Garden Service - Jean Baptiste</p>
