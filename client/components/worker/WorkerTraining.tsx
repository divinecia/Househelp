      ...
      const mockTrainings: Training[] = [
        {
          ...
          description:
            "Learn the fundamentals of professional house cleaning including proper techniques and safety measures",
        ...
        },
        {
          ...
          description:
            "Master different fabric care, stain removal, and proper ironing techniques",
          category: "Laundry",
          duration: "3 hours",
          status: "in-progress",
          progress: 65,
        },
        {
          ...
          description:
            "Essential safety procedures and basic first aid for domestic workers",
          category: "Safety",
          duration: "4 hours",
          status: "completed",
          progress: 100,
        ...
        },
        {
          ...
          description:
            "Effective communication skills for working with homeowners and families",
        ...
        },
        {
          ...
          description:
            "Comprehensive training on kitchen cleanliness and food handling safety",
          category: "Kitchen",
          duration: "3 hours",
          status: "not-started",
          progress: 0,
        },
        {
          ...
          description:
            "Introduction to lawn care, plant maintenance, and basic gardening",
          category: "Gardening",
          duration: "2.5 hours",
          status: "in-progress",
          progress: 30,
    ...
    <div className="space-y-6">
      ...
      {filteredTrainings.length === 0 ? (
        <div className="text-center py-12 text-gray-500">
          ...
          <p className="text-lg">
            No {filter !== "all" ? filter.replace("-", " ") : ""} trainings
            found
          </p>
        </div>
      ) : (
            ...
            >
              <div className="flex justify-between items-start mb-3">
                <div className="flex-1">
                  ...
                  <span
                    className={`px-3 py-1 text-xs rounded-full ${getStatusColor(training.status)}`}
                  >
