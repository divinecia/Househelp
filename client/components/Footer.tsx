...
export default function Footer({ className }: FooterProps) {
  ...
  return (
    <footer id="footer" className={cn("bg-gray-50 border-t border-gray-200", className)}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="mailto:hello@househelprw.com" className="flex items-center gap-2 text-muted-foreground hover:text-primary text-sm transition">
              <Mail size={18} />
        ...
        <div className="border-t border-gray-200 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            © {currentYear} HOUSEHELP. Professional household services platform.
          </p>
          <div className="flex gap-4">
            <a href="#terms" className="text-muted-foreground hover:text-primary text-sm transition">Terms of Service</a>
            <span className="text-gray-300">•</span>
            <a href="#privacy" className="text-muted-foreground hover:text-primary text-sm transition">Privacy Policy</a>
          </div>
        </div>
      </div>
    </footer>
