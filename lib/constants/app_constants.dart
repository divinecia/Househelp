...
class AppConstants {
  ...
  // App Colors - Updated with requested color scheme
  static const Color primaryColor = Color.fromRGBO(138, 165, 208, 1.0); // Light Blue
  static const Color secondaryColor = Color.fromRGBO(108, 135, 178, 1.0); // Darker shade of light blue
  static const Color accentColor = Color.fromRGBO(95, 108, 126, 1.0); // Accent Gray
  static const Color backgroundColor = Color.fromRGBO(255, 255, 255, 1.0); // Clean White
  static const Color surfaceColor = Color.fromRGBO(248, 249, 250, 1.0); // Very light gray for surfaces
  static const Color errorColor = Color(0xFFD32F2F);
  static const Color successColor = Color(0xFF4CAF50);
  static const Color warningColor = Color(0xFFFF9800);

  // User Type Colors
  static const Color workerColor = Color.fromRGBO(138, 165, 208, 1.0); // Light Blue
  static const Color householdColor = Color.fromRGBO(108, 135, 178, 1.0); // Darker Light Blue
  static const Color adminColor = Color.fromRGBO(95, 108, 126, 1.0); // Accent Gray

  // Text Colors
  static const Color textPrimary = Color.fromRGBO(95, 108, 126, 1.0); // Accent Gray
  static const Color textSecondary = Color.fromRGBO(125, 138, 156, 1.0); // Lighter shade of accent gray
  static const Color textLight = Color.fromRGBO(155, 168, 186, 1.0); // Even lighter gray
  static const Color textWhite = Color.fromRGBO(255, 255, 255, 1.0); // Clean White
