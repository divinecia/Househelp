...
class _PaymentAnalyticsWidgetState extends State<PaymentAnalyticsWidget> {
  ...
  Widget _buildPaymentChart() {
    ...
    if (total == 0) {
      return const Center(child: Text('No payment data for selected period'));
    }
              ...
              PieChartData(
                ...
                sections: [
                  PieChartSectionData(
                    ...
                    title:
                        '${(servicePayments / total * 100).toStringAsFixed(1)}%',
                    radius: 60,
                  ...
                  PieChartSectionData(
                    ...
                    title:
                        '${(trainingPayments / total * 100).toStringAsFixed(1)}%',
                    radius: 60,
                    titleStyle: const TextStyle(
                      fontSize: 12,
                      fontWeight: FontWeight.bold,
