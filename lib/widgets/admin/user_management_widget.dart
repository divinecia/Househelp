...
class _UserManagementWidgetState extends State<UserManagementWidget> {
  ...
  Widget _buildUserStats() {
    ...
    return Row(
      children: [
        Expanded(
          child: _buildStatCard('Total', totalUsers.toString(), AppConstants.primaryColor),
        ),
        const SizedBox(width: AppConstants.paddingSmall),
        Expanded(
          child: _buildStatCard('Active', activeUsers.toString(), AppConstants.successColor),
        ),
        const SizedBox(width: AppConstants.paddingSmall),
        Expanded(
          child: _buildStatCard('Pending', pendingUsers.toString(), AppConstants.warningColor),
        ),
        const SizedBox(width: AppConstants.paddingSmall),
        Expanded(
          child: _buildStatCard('Suspended', suspendedUsers.toString(), AppConstants.errorColor),
        ),
      ],
    );
  }
        ...
        subtitle: Column(
          ...
          children: [
            ...
            Row(
              children: [
                if (isEmailVerified)
                  const Icon(Icons.email, color: AppConstants.successColor, size: 16)
                else
                  const Icon(Icons.email_outlined, color: AppConstants.errorColor, size: 16),
                const SizedBox(width: 4),
                if (isPhoneVerified)
                  const Icon(Icons.phone, color: AppConstants.successColor, size: 16)
                else
                  const Icon(Icons.phone_outlined, color: AppConstants.errorColor, size: 16),
                const SizedBox(width: AppConstants.paddingSmall),
                Text(
