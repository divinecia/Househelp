          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildStatCard('Total Users', '1,234', AppConstants.primaryColor),
                  ),
                  const SizedBox(width: AppConstants.paddingMedium),
                  Expanded(
                    child: _buildStatCard('Active Workers', '456', AppConstants.workerColor),
                  ),
                ],
              ),
              const SizedBox(height: AppConstants.paddingMedium),
              ...
              Row(
                children: [
                  Expanded(
                    child: _buildStatCard('Households', '678', AppConstants.householdColor),
                  ),
                  const SizedBox(width: AppConstants.paddingMedium),
                  Expanded(
                    child: _buildStatCard('Jobs Today', '89', AppConstants.warningColor),
                  ),
                ],
              ),
