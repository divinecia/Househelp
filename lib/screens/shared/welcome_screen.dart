  ...
  void _onContinueAsGuest() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Guest mode is not yet implemented. Please register or login to continue.'),
        actions: [
          TextButton(
        ...
        actions: [
          TextButton(
            onPressed: () {
              ...
              NavigationHelper.goToLogin(context, userType: AppConstants.userTypeWorker);
            },
          ...
          TextButton(
            onPressed: () {
              Navigator.of(context).pop();
              NavigationHelper.goToLogin(context, userType: AppConstants.userTypeHousehold);
            },
          ...
          TextButton(
            onPressed: () {
              Navigator.of(context).pop();
              NavigationHelper.goToLogin(context, userType: AppConstants.userTypeAdmin);
            },
