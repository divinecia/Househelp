...
class _HouseholdDashboardState extends State<HouseholdDashboard> {
  ...
  Future<void> _loadDashboardData() async {
    try {
      ...
      final futures = await Future.wait([
        JobService.getJobStatistics(userId: widget.userId, userType: 'household'),
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => HouseholdProfileScreen(userId: widget.userId),
              ),
            ),
          ),
        ],
  ...
  Widget _buildStatsCards(Map<String, dynamic> jobStats, Map<String, dynamic> loyaltyStats) {
    return Row(
      children: [
        Expanded(
            ...
            SizedBox(
              ...
              child: BarChart(
                BarChartData(
                  ...
                  barGroups: [
                    BarChartGroupData(x: 0, barRods: [BarChartRodData(toY: 45000, color: AppConstants.primaryBlue)]),
                    BarChartGroupData(x: 1, barRods: [BarChartRodData(toY: 65000, color: AppConstants.primaryBlue)]),
                    BarChartGroupData(x: 2, barRods: [BarChartRodData(toY: 55000, color: AppConstants.primaryBlue)]),
                    BarChartGroupData(x: 3, barRods: [BarChartRodData(toY: 75000, color: AppConstants.primaryBlue)]),
                    BarChartGroupData(x: 4, barRods: [BarChartRodData(toY: 85000, color: AppConstants.primaryBlue)]),
                    BarChartGroupData(x: 5, barRods: [BarChartRodData(toY: 95000, color: AppConstants.primaryBlue)]),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildServicePackageCard(String title, String price, String description, IconData icon, Color color) {
    return Container(
      width: 160,
