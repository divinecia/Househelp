  ...
  static GoRouter createRouter() {
    return GoRouter(
      ...
      errorBuilder: (context, state) =>
          ErrorScreen(error: 'Page not found: ${state.fullPath}'),
    );
  }
}
...
class WorkerProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('Worker Profile Screen')));
  }
}
...
class AdminProfileScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('Admin Profile Screen')));
  }
}
...
class PrivacySettingsScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const Scaffold(body: Center(child: Text('Privacy Settings Screen')));
  }
}
